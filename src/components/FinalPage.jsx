            ...
            <BgImage fluid={ backgroundImage.childImageSharp.fluid }
                ...
                <div className='final-page'>
                    ...
                    <div className='final-page__socials'>
                        <p>Share</p>
                        <a href={ `https://www.facebook.com/sharer/sharer.php?u=${this.props.url}/${this.props.path}` }>
                            <img src={ facebook } alt='Share Facebook' />
                        </a>
                        <a href={ `https://twitter.com/intent/tweet?text=${this.props.url}/${this.props.path}` }>
                            <img src={ twitter } alt='Share Twitter' />
                        </a>
                        <a href={ `mailto:info@example.com?&subject=&body=${this.props.url}/${this.props.path}` }>
